...
//                 Dashboard <ChevronRight size={14} className="mx-2" /> 
//                 <span className="text-[#002D62]">{activeTab}</span>
//             </div>
            
//             <div className="flex items-center gap-4">
//                 <button className="p-2 text-gray-400 hover:text-[#002D62] transition-colors">
//                     <Bell size={20} />
//                 </button>
//                 <div className="flex items-center gap-3 pl-4 border-l border-gray-100">
//                     <div className="text-right">
//                         <p className="text-xs font-black text-[#002D62] leading-tight">{user?.fullName}</p>
//                         <p className="text-[10px] text-gray-400 font-bold">CUSTOMER</p>
//                     </div>
//                     <div className="w-10 h-10 rounded-full bg-[#002D62] text-white flex items-center justify-center font-bold border-2 border-white shadow-sm">
        ...
        <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-gray-100 px-4 md:px-8 py-3 md:py-4 flex items-center justify-between transition-all">
            ...
            <div className="flex items-center">
                <div className="hidden sm:flex items-center text-[10px] md:text-xs font-black text-gray-400 uppercase tracking-[0.2em]">
                    <span className="hover:text-[#002D62] cursor-pointer transition-colors">Portal</span>
            ...
            <div className="flex items-center gap-2 md:gap-4">
                ...
                <div className="flex items-center gap-2 md:gap-3 pl-2 md:pl-4 border-l border-gray-100 ml-1 md:ml-0">
                    ...
                    <button className="w-9 h-9 md:w-11 md:h-11 rounded-xl bg-[#002D62] text-white flex items-center justify-center font-bold border-2 border-white shadow-lg shadow-blue-900/10 hover:scale-105 active:scale-95 transition-all">
                        {user?.fullName ? (
                            <span className="text-xs md:text-sm">{user.fullName.charAt(0)}</span>
                        ) : (
                            <User size={18} />
                        )}
                    </button>
