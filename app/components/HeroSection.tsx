...
// 							{/* Corrected: Added href prop for navigation */}
// 							<Button
// 								href='/apply'
...
// 							{/* Corrected: Wrapped in Link for "How it works" navigation */}
// 							<Link href='/how-it-works'>
// 								<button className='flex items-center gap-3 px-6 h-16 text-[#002D62] font-bold hover:text-blue-600 transition-colors group'>
...
// 							<img
// 								src='https://upload.wikimedia.org/wikipedia/commons/b/b5/Trustpilot_logo.svg'
// 								alt='Trustpilot'
